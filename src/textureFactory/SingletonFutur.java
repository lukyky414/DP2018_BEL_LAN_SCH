...
public class SingletonFutur extends SingletonEpoque {
    ...
    private SingletonFutur(){
        ...
        list_icon.add(SingletonEpoque.redimensionner((new ImageIcon(chemin+"Bateau 2T2-1.png")),SingletonEpoque.TAILLE));
        list_icon.add(SingletonEpoque.redimensionner((new ImageIcon(chemin+"Bateau 2T2-2.png")),SingletonEpoque.TAILLE));
